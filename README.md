...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/bare-metal-vpc/ibm/latest)
...
## Overview
<ul>
  <li><a href="#terraform-ibm-bare-metal-vpc">terraform-ibm-bare-metal-vpc</a></li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/modules">Submodules</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/modules/baremetal">baremetal</a></li>
    </ul>
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/examples/advanced">Advanced example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/examples/basic">Basic example</a>
        <a href="https://cloud.ibm.com/schematics/workspaces/create?workspace_name=bare-metal-vpc-basic-example&repository=https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/examples/basic"><img src="https://img.shields.io/badge/Deploy%20with%20IBM%20Cloud%20Schematics-0f62fe?style=flat&logo=ibm&logoColor=white&labelColor=0f62fe" alt="Deploy with IBM Cloud Schematics" style="height: 16px; vertical-align: text-bottom; margin-left: 5px;"></a>
      </li>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-bare-metal-vpc/tree/main/examples/multi-zone-deployment">Multi-zone example</a>
...
| <a name="module_sg_group"></a> [sg\_group](#module\_sg\_group) | terraform-ibm-modules/security-group/ibm | 2.10.0 |
...
| <a name="input_security_group_rules"></a> [security\_group\_rules](#input\_security\_group\_rules) | A list of security group rules to be added to the default vpc security group | <pre>list(<br/>    object({<br/>      name      = string<br/>      direction = optional(string, "inbound")<br/>      remote    = string<br/>      protocol  = optional(string)<br/>      port_min  = optional(number)<br/>      port_max  = optional(number)<br/>      type      = optional(number)<br/>      code      = optional(number)<br/>    })<br/>  )</pre> | `[]` | no |
