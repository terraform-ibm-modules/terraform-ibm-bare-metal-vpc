...
| <a name="output_baremetal_server_primary_vni_name"></a> [baremetal\_server\_primary\_vni\_name](#output\_baremetal\_server\_primary\_vni\_name) | Output for primary virtual network interface name. |
...
| <a name="output_baremetal_server_secondary_vni_name"></a> [baremetal\_server\_secondary\_vni\_name](#output\_baremetal\_server\_secondary\_vni\_name) | Output for secondary virtual network interface name. |
